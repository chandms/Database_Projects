...
ALTER TABLE airport
ADD Constraint airport_cons CHECK (latitude>=-90 and latitude<=90 and longitude>=-180 and longitude<=180 and gmtoffset>=-12 and gmtoffset<=14);

ALTER TABLE country_continent
ADD Constraint country_cons CHECK (encompass_percentage>=0 and encompass_percentage<=100 );

ALTER TABLE city
ADD Constraint city_cons CHECK (latitude>=-90 and latitude<=90 and longitude>=-180 and longitude<=180);

ALTER TABLE ethnicgroup
ADD Constraint ethnic_cons CHECK (ethnic_group_percentage>=0 and ethnic_group_percentage<=100 );

ALTER TABLE language
ADD Constraint lang_cons CHECK (percentage>=0 and percentage<=100 );

ALTER TABLE religion
ADD Constraint rel_cons CHECK (percentage>=0 and percentage<=100 );
